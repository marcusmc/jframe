	...
	options: {
		...
		**/
		...
		errorDetector: function(requestInstance, responseText) {
			...
			return responseText.contains('jframe-error-popup');
		},
	...
	_setRequestOptions: function(request, options) {
		...
		*/
		...
		request.setOptions($merge({
			...
			onJFrameErrorPopup: function(alert){
